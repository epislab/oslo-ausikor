...
class DraftEntity(Base):
    """Draft 테이블 정의"""
    __tablename__ = "draft"

    draft_id = Column(String(50), primary_key=True, index=True, doc="초안 ID")
    draft_title = Column(String(255), nullable=False, doc="초안 제목")
    company_id = Column(String(50), nullable=False, doc="회사 ID")
    user_id = Column(String(50), nullable=False, doc="사용자 ID")
    status = Column(String(50), nullable=False, doc="초안 상태")
