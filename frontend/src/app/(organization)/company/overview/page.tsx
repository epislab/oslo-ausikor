...
import CompanyDummyTable from "@/domain/organization/company/component/CompanyDummyTable";
...
export default function CompanySearch() {
    ...
    if (isMobile) {
        return (
            <div className="relative w-full min-h-screen bg-white text-black overflow-x-hidden flex flex-col" >
                <div className="bg-gray-200 p-4 rounded shadow flex justify-between items-center" style={{ marginTop: '200px' }}>
    ...
    return (
        <div className="relative w-full h-screen overflow-hidden text-white">
            <main className=" mt-6 flex flex-col items-center" style={{ marginTop: '200px' }}>
                <section className="scrollable-section w-full max-w-lg p-4">
                    {/* 검색 폼 */}
                    <form className="form__companyName flex items-center gap-2" onSubmit={handleSearch}>
                        <input
...
function setCompanyName(query: string) {
