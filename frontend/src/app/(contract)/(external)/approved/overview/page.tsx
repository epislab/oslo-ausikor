...
import { contractData } from "@/components/samples/contractData";
import { AccordionRow } from "@/components/types/AccordionRow";

export default function ApprovedOverview() {
    const [accordionData] = useState<AccordionRow[]>(contractData);
