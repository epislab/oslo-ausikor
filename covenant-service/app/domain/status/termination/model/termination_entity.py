...
class TerminationEntity(Base):
    """Termination 테이블 정의"""
    __tablename__ = "termination"

    termination_id = Column(String(50), primary_key=True, index=True, doc="최종 ID")
    termination_title = Column(String(255), nullable=False, doc="최종 제목")
    company_id = Column(String(50), nullable=False, doc="회사 ID")
    user_id = Column(String(50), nullable=False, doc="사용자 ID")
    status = Column(String(50), nullable=False, doc="상태")
