...
class PendingEntity(Base):
    ...
    approval_id = Column(String(50), primary_key=True, index=True, doc="승인 ID")
    approval_title = Column(String(255), nullable=False, doc="승인 제목")
    company_id = Column(String(50), nullable=False, doc="회사 ID")
    user_id = Column(String(50), nullable=False, doc="사용자 ID")
    status = Column(String(50), nullable=False, doc="승인 상태")
