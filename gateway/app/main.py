...
from app.domain.discovery.controller.discovery_factory import DiscoveryFactory
from app.utility.types.service_type import ServiceType
...
# ✅ 루트 경로 엔드포인트 추가
@app.get("/", summary="홈페이지")
async def home():
    return {"message": "Welcome Home", "status": "Gateway API is running!", "version": "0.1.0"}
...
async def proxy_get(
    ...
    factory = DiscoveryFactory(service_type=service)
