...
class SignedEntity(Base):
    """Signed 테이블 정의"""
    __tablename__ = "signed"

    signed_id = Column(String(50), primary_key=True, index=True, doc="서명 ID")
    signed_title = Column(String(255), nullable=False, doc="서명 제목")
    company_id = Column(String(50), nullable=False, doc="회사 ID")
    user_id = Column(String(50), nullable=False, doc="사용자 ID")
    status = Column(String(50), nullable=False, doc="서명 상태")
